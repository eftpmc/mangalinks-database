...
export default function Search(data){
    ...
    <main>
      <ul id="nav">
        ...
        <div><IconButton onClick={() => console.log(value)} colorScheme="purple" aria-label='Search database' icon={<MdSearch />} /></div>
      </ul>
      <div id="core">
        <table>
          <tbody id="tablebody">
...
export async function getServerSideProps({params}){
  ...
  await page.goto('https://mangadex.org/search?q=' + params.id);
